...
return [
    ...
    "repositories" => [
        "database" => [
            "type" =>
                Spatie\LaravelSettings\SettingsRepositories\DatabaseSettingsRepository::class,
            "model" => null,
            "table" => null,
            "connection" => null,
        ],
        "redis" => [
            "type" =>
                Spatie\LaravelSettings\SettingsRepositories\RedisSettingsRepository::class,
            "connection" => null,
            "prefix" => null,
        ],
    ],
    ...
    "global_casts" => [
        DateTimeInterface::class =>
            Spatie\LaravelSettings\SettingsCasts\DateTimeInterfaceCast::class,
        DateTimeZone::class =>
            Spatie\LaravelSettings\SettingsCasts\DateTimeZoneCast::class,
        //        Spatie\DataTransferObject\DataTransferObject::class => Spatie\LaravelSettings\SettingsCasts\DtoCast::class,
        Spatie\LaravelData\Data::class =>
            Spatie\LaravelSettings\SettingsCasts\DataCast::class,
    ],
